...
import com.api.agviagem.models.Destinos;
import com.api.agviagem.repositories.DestinosRepository;
...
public class DestinosController {
	...
	@PostMapping
	public Destinos saveDestino(@RequestBody Destinos destinos) {
	...
	public Destinos update(@PathVariable Long idDestino, @RequestBody Destinos destinos) {
